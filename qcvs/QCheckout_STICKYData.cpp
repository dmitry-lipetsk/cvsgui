...
QCheckout_STICKYData::QCheckout_STICKYData
(
	QWidget* parent,
	const char* name
)
...
void QCheckout_STICKYData::OnDateCheck(bool)
{
}
void QCheckout_STICKYData::OnRevCheck(bool)
{
}
