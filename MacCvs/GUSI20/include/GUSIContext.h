...
// %                                                                       
// % $Log: GUSIContext.h,v $
// % Revision 1.13  2002/01/10 17:35:51  aubonbeurre
// % Update to GUSI 2.1.9
// %                                              
// % Revision 1.23.4.1  2001/11/07 06:28:50  aubonbeurre                   
...
public:
	...
	virtual OSErr SetThreadSwitcher(
				ThreadID thread, ThreadSwitchUPP threadSwitcher, void *switchProcParam, 
				Boolean inOrOut);
	virtual OSErr SetThreadTerminator(
				ThreadID thread, ThreadTerminationUPP threadTerminator, void *terminatorParam);
...
public:
	...
	void SetSwitchIn(ThreadSwitchUPP switcher, void *switchParam);
	void SetSwitchOut(ThreadSwitchUPP switcher, void *switchParam);
	void SetTerminator(ThreadTerminationUPP terminator, void *terminationParam);	
...
protected:
 ...
 //                                                                         
 // <Friends of [[GUSIContext]]>=                                           
 friend pascal void GUSIThreadSwitchIn(ThreadID thread, void *switchProcParam);
 friend pascal void GUSIThreadSwitchOut(ThreadID thread, void *switchProcParam);
 // The terminator wakes up the joining thread if a join is pending.        
 //                                                                         
 // <Friends of [[GUSIContext]]>=                                           
 friend pascal void GUSIThreadTerminator(ThreadID thread, void *terminationProcParam);
 ...
 ThreadSwitchUPP				fSwitchInProc;
 ThreadSwitchUPP				fSwitchOutProc;
 ThreadTerminationUPP		fTerminateProc;
 void *						fSwitchInParam;
