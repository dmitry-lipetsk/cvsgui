...
/*
 * LCheckEnabler.h --- enable/disable a view when activated/deactivated
 */

#include "LCheckEnabler.h"

LCheckEnabler::LCheckEnabler(LStream *inStream) : LCheckBox(inStream)
{
	inStream->ReadData(&mEnableView, sizeof(PaneIDT));
}

LCheckEnabler::~LCheckEnabler()
{
}

void LCheckEnabler::SetValue(
	SInt32	inValue)
{
