...
class UProcessUtils
{
	public:
		...
		static Boolean	LocateApplicationBySig(
																			OSType 								inAppCreator,
																			FSSpec& 							outSpec);
		...
		static OSErr	LaunchApplication(
																			FSSpec& 							inSpec,
																			UInt16								inLaunchFlags,
																			ProcessSerialNumber& 	outPSN);
										 
		static void			SendAppToFront(const ProcessSerialNumber& inWhichProcess);
