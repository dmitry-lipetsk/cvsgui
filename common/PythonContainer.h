...
//
// [2012-11-10]
//  sf_animal: I agree, that these rules in not ideal.
//             You can replace them onto more right.

#if !defined(USE_PYTHON)
#	define USE_PYTHON 1
#endif

#if defined(WIN32) && !qCvsDebug /* || qCarbon */
...
#if defined(WIN32) && defined(_DEBUG) && (USE_PYTHON!=2)
//	temporary turn off _DEBUG
#	undef _DEBUG
//	note: NDEBUG not defined.
//	release library
#	include <Python.h>
#	define _DEBUG
#else
//	debug or release libraries
#	include <Python.h>
#endif
